...
const sections = [
  ...
  ["2. Your account", "Provide accurate information, protect your sign-in account and do not impersonate another person. You are responsible for activity you authorize through your account. Notify x.rcarino1996@gmail.com if you suspect unauthorized access."],
...
export default function TermsPage() {
  return <main className={styles.page}><div className={styles.wrap}>
    ...
    <footer className={styles.footer}><Link href="/privacy">Privacy Policy</Link><a href="mailto:x.rcarino1996@gmail.com">Contact Openly</a></footer>
  </div></main>;
}
